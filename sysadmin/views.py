...
from bfc.sysadmin.forms import *
from bfc.academics.models import *
from bfc.sysadmin.models import *
from bfc.student.models import Student
...
from bfc.bill.utils import getrandom
...
# #Set up name of school
    # School(name='Bright Future International College',address='26, Bajulaiye rd, somolu Lagos',logo="C:\Windows\www\Bright\bfc.static\school-logo/log.jpeg").save()
...
#     from bfc.ruffwal.rwadmin.models import tbluseracc
...
#     from bfc.hrm.rcwadmin.models import tbluseracc as rcad
...
def backup(request):
    if  "userid" in request.session:
        varuser = request.session['userid']
        if request.method == 'POST':
            source = "C:/windows/www/schapp/bfc.sofis.db" #os.path.normpath(os.path.dirname(sofis.db))
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    varvali.save()
                    #********************************************************
                    from bfc.hrm.rcwadmin.models import tbluseracc as hrmuser
