...
def uploadaccsubgrp(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            try:
                from bfc.ruffwal.rsetup.models import tblsubgroup
                for k in num:
                    j1 = k[0]#groupcode
                    j2 = k[1]#group name
                    j3 = k[2]#subcode
...
def uploadacc(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            try:
                from bfc.ruffwal.rsetup.models import tblaccount,tblsubgroup
                for k in num:
                    j1 = k[0]#accname
                    j2 = k[1]#acccode
                    j3 = k[2]#datecreated
...
def uploadtransaction(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #try:
            from bfc.ruffwal.rsetup.models import tblaccount,tblsubgroup
            from bfc.ruffwal.posting.models import tbltransaction
            for k in num:
                j1 = k[0]#acccode
                j2 = k[1]#transdate
                j3 = k[2]#cheque no
...
def uploadbill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            #try:
            from bfc.bill.models import tblbill
...
def uploadbillname(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            #try:
            from bfc.bill.models import tblexpenses
...
def uploadadditionalbill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            #try:
            from bfc.bill.models import tbladditionalbill
            for k in num:
                j1 = k[0]#session
                j2 = k[1]#name
                j3 = k[2]#klass
...
def uploadpostedbill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # print raw_str
            #try:
            from bfc.bill.models import postedbill
            for k in num:
                j1 = k[0]#session
                j2 = k[1]#klass
                j3 = k[2]#term
