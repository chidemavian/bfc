...
DATABASES = {
    'default': {
        ...
        'NAME': 'bfc$bfc',                      # database name.
        'USER': 'bfc',                      # username to database access.
        'PASSWORD': 'chidemavian',                  # password to database.
        'HOST': 'bfc.mysql.pythonanywhere-services.com',  # database host.
...
MIDDLEWARE_CLASSES = (
    ...
    'bfc.middleware.ProfileMiddleware',
...
ALLOWED_HOSTS = ['bfc.pythonanywhere.com']
